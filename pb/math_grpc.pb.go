...
type MathClient interface {
	GetFactors(ctx context.Context, in *IntValue, opts ...grpc.CallOption) (*IntList, error)
}
...
func (c *mathClient) GetFactors(ctx context.Context, in *IntValue, opts ...grpc.CallOption) (*IntList, error) {
	out := new(IntList)
	err := c.cc.Invoke(ctx, "/Math/GetFactors", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MathServer interface {
	GetFactors(context.Context, *IntValue) (*IntList, error)
...
func (UnimplementedMathServer) GetFactors(context.Context, *IntValue) (*IntList, error) {
...
func _Math_GetFactors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IntValue)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MathServer).GetFactors(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Math/GetFactors",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MathServer).GetFactors(ctx, req.(*IntValue))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Math_GetFactors_Handler,
		},
	},
